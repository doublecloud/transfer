...
-- Table with long line (exceeds 4096 chars)


CREATE TABLE mtmobproxy.long_line
(
    `id` UInt64,
    `BasePath` String
)
...
INSERT INTO mtmobproxy.long_line
(`id`, `BasePath`)
VALUES
(1, repeat('a', 5000))
;
...
-- Table with values with fake backslash escaping


CREATE TABLE mtmobproxy.backslashes
(
    `id` UInt64,
    `v0` String,
    `v1` UInt64
...
INSERT INTO mtmobproxy.backslashes
(`id`, `v0`, `v1`)
VALUES
(1, '\\',3)
;
