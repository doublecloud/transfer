...
func TestPushClientLogs(t *testing.T) {
	...
	parserConfigStruct := &jsonparser.ParserConfigJSONLb{
		Fields: []abstract.ColSchema{
			...
			{ColumnName: "non_exist_col", DataType: ytschema.TypeString.String(), Required: true},
		},
		AddRest: false,
	}
	...
	require.NoError(t, helpers.WaitDestinationEqualRowsCount("", lbEnv.DefaultTopic+"_unparsed", helpers.GetSampleableStorageByModel(t, dst.LegacyModel()), 60*time.Second, 50))
}
