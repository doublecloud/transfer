...
import (
	...
	"github.com/doublecloud/tross/transfer_manager/go/pkg/parsers/registry/debezium"
	...
	"github.com/doublecloud/tross/transfer_manager/go/pkg/providers/eventhub"
	"github.com/doublecloud/tross/transfer_manager/go/pkg/providers/greenplum"
	"github.com/doublecloud/tross/transfer_manager/go/pkg/providers/kafka"
	"github.com/doublecloud/tross/transfer_manager/go/pkg/providers/logbroker"
	"github.com/doublecloud/tross/transfer_manager/go/pkg/providers/mongo"
	...
	"github.com/doublecloud/tross/transfer_manager/go/pkg/providers/yds"
...
func checkDst(t *testing.T, src server.Source, serializerName server.SerializationFormatName, transferType abstract.TransferType, expectedOk bool) {
	dst := logbroker.LbDestination{FormatSettings: server.SerializationFormat{Name: serializerName}}
	if expectedOk {
...
func TestSourceCompatible(t *testing.T) {
	...
	for i, el := range testCases {
		...
		if el.expectedOk {
			require.Equal(t, el.inferredSerializationFormat, logbroker.InferFormatSettings(el.src, server.SerializationFormat{Name: server.SerializationFormatAuto}).Name)
		} else {
