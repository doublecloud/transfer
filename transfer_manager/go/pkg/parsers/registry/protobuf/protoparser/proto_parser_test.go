...
import (
	...
	"github.com/doublecloud/tross/library/go/core/metrics/mock"
	"github.com/doublecloud/tross/transfer_manager/go/pkg/abstract"
	"github.com/doublecloud/tross/transfer_manager/go/pkg/parsers"
	"github.com/doublecloud/tross/transfer_manager/go/pkg/parsers/registry/protobuf/protoparser/gotest/prototest"
...
func getCloudExportHitsTestCases(t *testing.T) []struct {
	...
	rootMsgDesc, err := extractMessageDesc(
		protoSampleContent(t, "metrika_cloud_export_hit_log.desc"),
...
func TestDoCloudExportHits(t *testing.T) {
	...
	for i, tc := range testCases {
		t.Run(fmt.Sprintf("case_%d", i), func(t *testing.T) {
			...
			for _, ci := range got {
				require.Equal(t, tc.colsLen, len(ci.ColumnNames))
			}
		})
	}
}
