...
var file_yandex_cloud_mdb_mysql_v1_backup_proto_rawDesc = []byte{
	...
	0x41, 0x54, 0x49, 0x4e, 0x47, 0x10, 0x02, 0x42, 0x6c, 0x0a, 0x1d, 0x79, 0x61, 0x6e, 0x64, 0x65,
...
var file_yandex_cloud_mdb_mysql_v1_backup_proto_goTypes = []interface{}{
...
func file_yandex_cloud_mdb_mysql_v1_backup_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_yandex_cloud_mdb_mysql_v1_backup_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Backup); i {
			case 0:
				return &v.state
			case 1:
