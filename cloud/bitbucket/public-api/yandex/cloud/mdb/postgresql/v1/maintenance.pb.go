...
func (WeeklyMaintenanceWindow_WeekDay) Descriptor() protoreflect.EnumDescriptor {
	return file_yandex_cloud_mdb_postgresql_v1_maintenance_proto_enumTypes[0].Descriptor()
}

func (WeeklyMaintenanceWindow_WeekDay) Type() protoreflect.EnumType {
	return &file_yandex_cloud_mdb_postgresql_v1_maintenance_proto_enumTypes[0]
}
...
func (WeeklyMaintenanceWindow_WeekDay) EnumDescriptor() ([]byte, []int) {
	return file_yandex_cloud_mdb_postgresql_v1_maintenance_proto_rawDescGZIP(), []int{2, 0}
}
...
func (x *MaintenanceWindow) Reset() {
	*x = MaintenanceWindow{}
	if protoimpl.UnsafeEnabled {
		mi := &file_yandex_cloud_mdb_postgresql_v1_maintenance_proto_msgTypes[0]
...
func (*MaintenanceWindow) Descriptor() ([]byte, []int) {
	return file_yandex_cloud_mdb_postgresql_v1_maintenance_proto_rawDescGZIP(), []int{0}
}
...
func (x *AnytimeMaintenanceWindow) Reset() {
	*x = AnytimeMaintenanceWindow{}
	if protoimpl.UnsafeEnabled {
		mi := &file_yandex_cloud_mdb_postgresql_v1_maintenance_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (x *WeeklyMaintenanceWindow) Reset() {
	*x = WeeklyMaintenanceWindow{}
	if protoimpl.UnsafeEnabled {
		mi := &file_yandex_cloud_mdb_postgresql_v1_maintenance_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*WeeklyMaintenanceWindow) Descriptor() ([]byte, []int) {
	return file_yandex_cloud_mdb_postgresql_v1_maintenance_proto_rawDescGZIP(), []int{2}
}
...
func (x *MaintenanceOperation) Reset() {
	*x = MaintenanceOperation{}
	if protoimpl.UnsafeEnabled {
		mi := &file_yandex_cloud_mdb_postgresql_v1_maintenance_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
var file_yandex_cloud_mdb_postgresql_v1_maintenance_proto_rawDesc = []byte{
	...
	0x74, 0x67, 0x72, 0x65, 0x73, 0x71, 0x6c, 0x2e, 0x76, 0x31, 0x2e, 0x41, 0x6e, 0x79, 0x74, 0x69,
	...
	0x73, 0x74, 0x67, 0x72, 0x65, 0x73, 0x71, 0x6c, 0x2e, 0x76, 0x31, 0x2e, 0x57, 0x65, 0x65, 0x6b,
	...
	0x6c, 0x61, 0x79, 0x65, 0x64, 0x55, 0x6e, 0x74, 0x69, 0x6c, 0x42, 0x7b, 0x0a, 0x22, 0x79, 0x61,
...
var (
	file_yandex_cloud_mdb_postgresql_v1_maintenance_proto_rawDescOnce sync.Once
	file_yandex_cloud_mdb_postgresql_v1_maintenance_proto_rawDescData = file_yandex_cloud_mdb_postgresql_v1_maintenance_proto_rawDesc
)

func file_yandex_cloud_mdb_postgresql_v1_maintenance_proto_rawDescGZIP() []byte {
	file_yandex_cloud_mdb_postgresql_v1_maintenance_proto_rawDescOnce.Do(func() {
		file_yandex_cloud_mdb_postgresql_v1_maintenance_proto_rawDescData = protoimpl.X.CompressGZIP(file_yandex_cloud_mdb_postgresql_v1_maintenance_proto_rawDescData)
	})
	return file_yandex_cloud_mdb_postgresql_v1_maintenance_proto_rawDescData
}

var file_yandex_cloud_mdb_postgresql_v1_maintenance_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_yandex_cloud_mdb_postgresql_v1_maintenance_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_yandex_cloud_mdb_postgresql_v1_maintenance_proto_goTypes = []interface{}{
	(WeeklyMaintenanceWindow_WeekDay)(0), // 0: yandex.cloud.mdb.postgresql.v1.WeeklyMaintenanceWindow.WeekDay
	(*MaintenanceWindow)(nil),            // 1: yandex.cloud.mdb.postgresql.v1.MaintenanceWindow
	(*AnytimeMaintenanceWindow)(nil),     // 2: yandex.cloud.mdb.postgresql.v1.AnytimeMaintenanceWindow
	(*WeeklyMaintenanceWindow)(nil),      // 3: yandex.cloud.mdb.postgresql.v1.WeeklyMaintenanceWindow
	(*MaintenanceOperation)(nil),         // 4: yandex.cloud.mdb.postgresql.v1.MaintenanceOperation
	(*timestamppb.Timestamp)(nil),        // 5: google.protobuf.Timestamp
}
var file_yandex_cloud_mdb_postgresql_v1_maintenance_proto_depIdxs = []int32{
	2, // 0: yandex.cloud.mdb.postgresql.v1.MaintenanceWindow.anytime:type_name -> yandex.cloud.mdb.postgresql.v1.AnytimeMaintenanceWindow
	3, // 1: yandex.cloud.mdb.postgresql.v1.MaintenanceWindow.weekly_maintenance_window:type_name -> yandex.cloud.mdb.postgresql.v1.WeeklyMaintenanceWindow
	0, // 2: yandex.cloud.mdb.postgresql.v1.WeeklyMaintenanceWindow.day:type_name -> yandex.cloud.mdb.postgresql.v1.WeeklyMaintenanceWindow.WeekDay
	5, // 3: yandex.cloud.mdb.postgresql.v1.MaintenanceOperation.delayed_until:type_name -> google.protobuf.Timestamp
...
func init() { file_yandex_cloud_mdb_postgresql_v1_maintenance_proto_init() }
func file_yandex_cloud_mdb_postgresql_v1_maintenance_proto_init() {
	if File_yandex_cloud_mdb_postgresql_v1_maintenance_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_yandex_cloud_mdb_postgresql_v1_maintenance_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_yandex_cloud_mdb_postgresql_v1_maintenance_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_yandex_cloud_mdb_postgresql_v1_maintenance_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_yandex_cloud_mdb_postgresql_v1_maintenance_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
	...
	file_yandex_cloud_mdb_postgresql_v1_maintenance_proto_msgTypes[0].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_yandex_cloud_mdb_postgresql_v1_maintenance_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_yandex_cloud_mdb_postgresql_v1_maintenance_proto_goTypes,
		DependencyIndexes: file_yandex_cloud_mdb_postgresql_v1_maintenance_proto_depIdxs,
		EnumInfos:         file_yandex_cloud_mdb_postgresql_v1_maintenance_proto_enumTypes,
		MessageInfos:      file_yandex_cloud_mdb_postgresql_v1_maintenance_proto_msgTypes,
	}.Build()
	File_yandex_cloud_mdb_postgresql_v1_maintenance_proto = out.File
	file_yandex_cloud_mdb_postgresql_v1_maintenance_proto_rawDesc = nil
	file_yandex_cloud_mdb_postgresql_v1_maintenance_proto_goTypes = nil
	file_yandex_cloud_mdb_postgresql_v1_maintenance_proto_depIdxs = nil
}
