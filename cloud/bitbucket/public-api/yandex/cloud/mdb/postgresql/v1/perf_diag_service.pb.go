...
var file_yandex_cloud_mdb_postgresql_v1_perf_diag_service_proto_rawDesc = []byte{
	...
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x7b, 0x0a, 0x22, 0x79, 0x61, 0x6e, 0x64,
	0x65, 0x78, 0x2e, 0x63, 0x6c, 0x6f, 0x75, 0x64, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x6d, 0x64, 0x62,
	0x2e, 0x70, 0x6f, 0x73, 0x74, 0x67, 0x72, 0x65, 0x73, 0x71, 0x6c, 0x2e, 0x76, 0x31, 0x5a, 0x55,
	...
	0x74, 0x67, 0x72, 0x65, 0x73, 0x71, 0x6c, 0x2f, 0x76, 0x31, 0x3b, 0x70, 0x6f, 0x73, 0x74, 0x67,
...
func (c *performanceDiagnosticsServiceClient) ListRawSessionStates(ctx context.Context, in *ListRawSessionStatesRequest, opts ...grpc.CallOption) (*ListRawSessionStatesResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/yandex.cloud.mdb.postgresql.v1.PerformanceDiagnosticsService/ListRawSessionStates", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *performanceDiagnosticsServiceClient) ListRawStatements(ctx context.Context, in *ListRawStatementsRequest, opts ...grpc.CallOption) (*ListRawStatementsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/yandex.cloud.mdb.postgresql.v1.PerformanceDiagnosticsService/ListRawStatements", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedPerformanceDiagnosticsServiceServer can be embedded to have forward compatible implementations.
...
func RegisterPerformanceDiagnosticsServiceServer(s *grpc.Server, srv PerformanceDiagnosticsServiceServer) {
	s.RegisterService(&_PerformanceDiagnosticsService_serviceDesc, srv)
}
...
func _PerformanceDiagnosticsService_ListRawSessionStates_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/yandex.cloud.mdb.postgresql.v1.PerformanceDiagnosticsService/ListRawSessionStates",
	}
...
func _PerformanceDiagnosticsService_ListRawStatements_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/yandex.cloud.mdb.postgresql.v1.PerformanceDiagnosticsService/ListRawStatements",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _PerformanceDiagnosticsService_serviceDesc = grpc.ServiceDesc{
