...
var file_yandex_cloud_mdb_greenplum_v1_pxf_service_proto_rawDesc = []byte{
	...
	0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x5f, 0x6e, 0x61, 0x6d, 0x65, 0x7d, 0x42, 0x78, 0x0a, 0x21,
	...
	0x31, 0x5a, 0x53, 0x61, 0x2e, 0x79, 0x61, 0x6e, 0x64, 0x65, 0x78, 0x2d, 0x74, 0x65, 0x61, 0x6d,
...
func (c *pXFDatasourceServiceClient) List(ctx context.Context, in *ListPXFDatasourcesRequest, opts ...grpc.CallOption) (*ListPXFDatasourcesResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/yandex.cloud.mdb.greenplum.v1.PXFDatasourceService/List", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *pXFDatasourceServiceClient) Create(ctx context.Context, in *CreatePXFDatasourceRequest, opts ...grpc.CallOption) (*operation.Operation, error) {
	...
	err := c.cc.Invoke(ctx, "/yandex.cloud.mdb.greenplum.v1.PXFDatasourceService/Create", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *pXFDatasourceServiceClient) Update(ctx context.Context, in *UpdatePXFDatasourceRequest, opts ...grpc.CallOption) (*operation.Operation, error) {
	out := new(operation.Operation)
	err := c.cc.Invoke(ctx, "/yandex.cloud.mdb.greenplum.v1.PXFDatasourceService/Update", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *pXFDatasourceServiceClient) Delete(ctx context.Context, in *DeletePXFDatasourceRequest, opts ...grpc.CallOption) (*operation.Operation, error) {
	out := new(operation.Operation)
	err := c.cc.Invoke(ctx, "/yandex.cloud.mdb.greenplum.v1.PXFDatasourceService/Delete", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedPXFDatasourceServiceServer can be embedded to have forward compatible implementations.
...
func RegisterPXFDatasourceServiceServer(s *grpc.Server, srv PXFDatasourceServiceServer) {
	s.RegisterService(&_PXFDatasourceService_serviceDesc, srv)
}
...
func _PXFDatasourceService_List_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/yandex.cloud.mdb.greenplum.v1.PXFDatasourceService/List",
	}
...
func _PXFDatasourceService_Create_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/yandex.cloud.mdb.greenplum.v1.PXFDatasourceService/Create",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _PXFDatasourceService_Update_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/yandex.cloud.mdb.greenplum.v1.PXFDatasourceService/Update",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _PXFDatasourceService_Delete_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/yandex.cloud.mdb.greenplum.v1.PXFDatasourceService/Delete",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _PXFDatasourceService_serviceDesc = grpc.ServiceDesc{
