...
var file_yandex_cloud_mdb_mongodb_v1_backup_service_proto_rawDesc = []byte{
	...
	0x4f, 0x70, 0x65, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x60, 0xb2, 0xd2, 0x2a, 0x2d, 0x0a,
	...
	0x02, 0x29, 0x2a, 0x27, 0x2f, 0x6d, 0x61, 0x6e, 0x61, 0x67, 0x65, 0x64, 0x2d, 0x6d, 0x6f, 0x6e,
	0x67, 0x6f, 0x64, 0x62, 0x2f, 0x76, 0x31, 0x2f, 0x62, 0x61, 0x63, 0x6b, 0x75, 0x70, 0x73, 0x2f,
	0x7b, 0x62, 0x61, 0x63, 0x6b, 0x75, 0x70, 0x5f, 0x69, 0x64, 0x7d, 0x42, 0x72, 0x0a, 0x1f, 0x79,
...
func (c *backupServiceClient) Delete(ctx context.Context, in *DeleteBackupRequest, opts ...grpc.CallOption) (*operation.Operation, error) {
	...
	err := c.cc.Invoke(ctx, "/yandex.cloud.mdb.mongodb.v1.BackupService/Delete", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _BackupService_Delete_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/yandex.cloud.mdb.mongodb.v1.BackupService/Delete",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
