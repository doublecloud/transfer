...
CREATE TABLE `mt-mob-proxy`.logs_weekly__mt_mt
(
    `ServerName` String,
    `DC` FixedString(3),
    `RequestDate` Date,
...
INSERT INTO `mt-mob-proxy`.logs_weekly__mt_mt
...
CREATE TABLE `mt-mob-proxy`.logs_weekly__nurmt_mt
(
    `ServerName` String,
    `DC` FixedString(3),
    `RequestDate` Date,
...
CREATE TABLE `mt-mob-proxy`.logs_weekly__nurmt_nurmt
(
    `ServerName` String,
    `DC` FixedString(3),
    `RequestDate` Date,
...
-- insert 3 rows (my-server2/my-server3/my-server4)
INSERT INTO `mt-mob-proxy`.logs_weekly__nurmt_nurmt
(`ServerName`, `DC`, `RequestDate`, `RequestDateTime`, `VirtualHost`,     `Path`, `BasePath`, `Code`, `RequestLengthBytes`, `FullRequestTime`, `UpstreamResponseTime`, `IsUpstreamRequest`, `SSLHanshakeTime`, `IsKeepalive`, `StringHash`, `HTTPMethod`, `commit_time`, `delete_time`)
VALUES
('my-server2', 'iva',  1546300800,   1546300800,       'my-virtual-host', 'a/b',  'a',        1,      2,                    3,                 4,                      'true',              5,                 'false',       6,            'HTTPMethod', 1,             0            ),('my-server3', 'iva',  1546300800,   1546300800,       'my-virtual-host', 'a/b',  'a',        1,      2,                    3,                 4,                      'true',              5,                 'false',       6,            'HTTPMethod', 1,             0),('my-server4', 'iva',  1546300800,   1546300800,       'my-virtual-host', 'a/b',  'a',        1,      2,                    3,                 4,                      'true',              5,                 'false',       6,            'HTTPMethod', 1,             0)
;
...
CREATE TABLE `mt-mob-proxy`.`.-logs_weekly__urmt_mt`
(
    `Server-.-Name` String,
    `DC` FixedString(3),
    `RequestDate` Date,
...
PARTITION BY toMonday(RequestDate)
ORDER BY (BasePath, Code, `Server-.-Name`, StringHash)
SAMPLE BY StringHash
SETTINGS index_granularity = 8192;

-- insert 4 rows (my-server2/my-server3/my-server4)
INSERT INTO `mt-mob-proxy`.`.-logs_weekly__urmt_mt`
(`Server-.-Name`, `DC`, `RequestDate`, `RequestDateTime`, `VirtualHost`,     `Path`, `BasePath`, `Code`, `RequestLengthBytes`, `FullRequestTime`, `UpstreamResponseTime`, `IsUpstreamRequest`, `SSLHanshakeTime`, `IsKeepalive`, `StringHash`, `HTTPMethod`, `__data_transfer_commit_time`, `__data_transfer_delete_time`)
VALUES
...
CREATE TABLE `mt-mob-proxy`.empty
(
    `BasePath` String DEFAULT 'misc',
    `Code` UInt16
)
