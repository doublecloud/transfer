...
func load(t *testing.T, transfer *server.Transfer, updateSource bool) {
	...
	helpers.CheckRowsCount(t, transfer.Src, "postgres", "measurement_inherited", 10)
	helpers.CheckRowsCount(t, transfer.Src, "postgres", "measurement_inherited_y2006m02", 3)
	helpers.CheckRowsCount(t, transfer.Src, "postgres", "measurement_inherited_y2006m03", 4)
	helpers.CheckRowsCount(t, transfer.Src, "public", "measurement_inherited_y2006m04", 3)

	helpers.CheckRowsCount(t, transfer.Src, "postgres", "measurement_declarative", 12)
	helpers.CheckRowsCount(t, transfer.Src, "postgres", "measurement_declarative_y2006m02", 3)
	helpers.CheckRowsCount(t, transfer.Src, "postgres", "measurement_declarative_y2006m03", 4)
	helpers.CheckRowsCount(t, transfer.Src, "public", "measurement_declarative_y2006m04", 3)
	helpers.CheckRowsCount(t, transfer.Src, "postgres", "measurement_declarative_y2006m05", 2)
	...
	require.NoError(t, helpers.WaitEqualRowsCount(t, "postgres", "measurement_inherited_y2006m02", sourceStorage, targetStorage, 60*time.Second))
	require.NoError(t, helpers.WaitEqualRowsCount(t, "postgres", "measurement_inherited_y2006m03", sourceStorage, targetStorage, 60*time.Second))
	...
	require.NoError(t, helpers.WaitEqualRowsCount(t, "postgres", "measurement_declarative_y2006m02", sourceStorage, targetStorage, 60*time.Second))
	require.NoError(t, helpers.WaitEqualRowsCount(t, "postgres", "measurement_declarative_y2006m03", sourceStorage, targetStorage, 60*time.Second))
	...
	helpers.CheckRowsCount(t, transfer.Dst, "postgres", "measurement_inherited", 10)
	helpers.CheckRowsCount(t, transfer.Dst, "postgres", "measurement_declarative", 12)
