...
CREATE TABLE public.measurement_inherited_y2006m04 (
...
ALTER TABLE public.measurement_inherited_y2006m04 ADD PRIMARY KEY (id, logdate);
...
DO INSTEAD
    INSERT INTO public.measurement_inherited_y2006m04 VALUES (NEW.*);
...
CREATE TABLE public.measurement_declarative_y2006m04 PARTITION OF measurement_declarative
...
ALTER TABLE public.measurement_declarative_y2006m04 ADD PRIMARY KEY (id, logdate);
