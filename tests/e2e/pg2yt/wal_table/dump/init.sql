...
CREATE TYPE full_address AS (city VARCHAR(128), street VARCHAR(256));
...
--     pl   pg_lsn
                        ...
                        json_arr    json[],
                        char_arr    "char"[],
                        udt_arr     full_address[],
                        primary key (aid, str, id, enum_v) -- test multi pk and reverse order keys
);
...
--     '0/0'
                            ...
                            '{"foo", "bar"}',
                            '{"sad", "ok"}',
                            ARRAY['{}', '{"foo": "bar"}', '{"arr": [1, 2, 3]}']::json[],
                            '{"f", "o", "o"}',
                            ARRAY['("Moscow","Lva Tolstogo 16")'::full_address, '("Saint-Petersburg","Piskarevskiy pr. 2")'::full_address]
                          )
        ,
                          (
                              3,
...
INSERT INTO test (str, id, enum_v) VALUES
    ('this should be updated', 100, 'ok'),
    ('this should be deleted', 100, 'ok');
